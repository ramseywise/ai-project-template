...
This is the ADK-side half of the same MCP integration lg_agent demonstrates
...
from agents.adk_agent.callbacks import before_model_rag
from agents.adk_agent.mcp_tools import get_mcp_toolset
