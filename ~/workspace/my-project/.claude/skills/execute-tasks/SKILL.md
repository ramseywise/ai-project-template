---
name: execute-tasks
description: Execute planned tasks from TASKS.md. Use when the user asks to implement tasks, work through a milestone, or says things like "execute the tasks", "work through TASKS.md", or "implement M1".
model: sonnet
---
